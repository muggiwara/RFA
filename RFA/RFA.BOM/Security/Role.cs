...
namespace Security
{
    ...
    public partial class Role : System.ICloneable, System.IComparable, System.IComparable<Security.Role>, CodeFluent.Runtime.ICodeFluentCollectionEntity<string>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<Security.Role>
    {
        ...
        private Security.UserCollection _users;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public Security.UserCollection Users
        {
            get
            {
                if ((this._users == null))
                {
                    ...
                    {
                        this._users = new Security.UserCollection(this);
                        return this._users;
                    }
                    this._users = Security.UserCollection.LoadUsersRolesByRole(this);
                }
                return this._users;
            }
        }
        ...
        public virtual bool Equals(Security.Role role)
        {
            if ((role == null))
            {
                return false;
        ...
        internal void SaveUsersRelations()
        {
            ...
            for (b = enumerator.MoveNext(); b; b = enumerator.MoveNext())
            {
                ...
                Security.User user = ((Security.User)(entry.Key));
...
role = value as Security.Role;
        ...
        public virtual int CompareTo(Security.Role role)
        {
            if ((role == null))
            {
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = RFA.Resources.Manager.GetStringWithDefault(culture, "Security.Role.ExternalValidate", "Type \'Security.Role\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = RFA.Resources.Manager.GetStringWithDefault(culture, "Security.Role.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'S" +
                        "ecurity.Role\'", null);
                CodeFluentPersistence.AddValidationError(results, localValidate);
            }
            if ((this.Name == default(string)))
            {
                string localValidate1 = RFA.Resources.Manager.GetStringWithDefault(culture, "Security.Role.Name.NullException", "\'Name\' property cannot be set to \'\' for type \'Security.Role\'", null);
        ...
        public static Security.Role Load(System.Guid id)
        {
        ...
        public static Security.Role LoadByName(string name)
        {
...
dictionary = values as System.Collections.IDictionary;
            ...
            Security.UserCollection users = null;
users = values as Security.UserCollection;
            if ((users != null))
            {
                this._users = users;
                return;
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static Security.Role LoadByEntityKey(string key)
        {
            if ((key == string.Empty))
            {
                return null;
        ...
        public Security.Role Clone(bool deep)
        {
            Security.Role role = new Security.Role();
        ...
        public Security.Role Clone()
        {
            Security.Role localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(Security.Role role, bool deep)
        {
            if ((role == null))
            {
                throw new System.ArgumentNullException("role");
